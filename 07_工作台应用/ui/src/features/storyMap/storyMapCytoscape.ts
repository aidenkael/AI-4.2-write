...
export const storyMapStyles = [
  { selector: 'node', style: { label: 'data(label)', 'background-color': '#dce7f8', color: '#172545', 'font-size': 12, 'text-wrap': 'wrap', 'text-max-width': '136px', 'text-justification': 'center', 'text-margin-y': 9, 'text-valign': 'bottom', 'text-halign': 'center', width: 60, height: 60, 'border-color': '#7896c8', 'border-width': 2 } },
