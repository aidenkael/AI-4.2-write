...
export function MockFormDialog({ title, children, submitLabel = '保存', onClose, onSubmit }: { title: string; children: ReactNode; submitLabel?: string; onClose(): void; onSubmit(event: FormEvent<HTMLFormElement>): void }) {
