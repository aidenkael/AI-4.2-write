...
export function HomePage() {
  ...
  return <div className="page home-page">
    ...
    <div className="home-grid">
      <button className="image-card" style={{ backgroundImage: `linear-gradient(180deg,rgba(255,255,255,.2),rgba(226,238,253,.15)),url(${mountains})` }} onClick={() => actions.openProject('mist', 'development')}><h2><Compass/>故事发展</h2><p>还有 1 件事值得想清楚</p><span>继续想故事 <ArrowRight/></span></button>
